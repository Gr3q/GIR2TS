...
declare namespace imports.gi.PangoCairo {
	...
	interface IFont {
		 ...
		 * {@link Cairo.ScaledFont.reference}.
	...
	class FontMap {
		 ...
		 *  not be freed.
		 */
		public static get_default(): Pango.FontMap;
		/**
		 ...
		 */
		public static new(): Pango.FontMap;
		/**
		 ...
		 *   {@link GObject.unref}, or %NULL if the requested cairo font backend
		 *   is not supported / compiled in.
		 */
		public static new_for_font_type(fonttype: cairo.FontType): Pango.FontMap | null;
	}
	...
	interface ShapeRendererFunc {
		 ...
		 * @param do_path whether only the shape path should be appended to current
